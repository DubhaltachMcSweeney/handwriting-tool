...
## 4. Font Generation / Personalised Rendering
...
- The project successfully demonstrates the “personalised handwriting-style output” goal from the proposal.
...
```text
handwritten image -> segmentation -> recognition -> user correction -> fine-tuning -> improved recognition -> personalised rendering
```
